    ...
    <div>
      <div className="container">
        <div className="slideshow">
          ...
          <button
            className="w-14 bg-[#222] border-slate-50 h-14 rounded-full border-2 borderbg-black opacity-60 text-[#4ff] text-2xl prevButton"
            onClick={prevStep}
          >
            {<IoIosArrowBack className="mx-auto text-4xl" />}
          </button>
          <button
            className="w-14 h-14 rounded-full border border-slate-50 borderbg-black bg-[#222] opacity-60 text-[#4ff] text-2xl nextButton"
            onClick={nextStep}
          >
            {<IoIosArrowForward className="mx-auto text-4xl" />}
          </button>
        </div>
      </div>
    </div>
